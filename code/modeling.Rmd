...
author: Saw Simeon, Hao Li, Aijaz Ahmad Malik, Abdul Hafeez Kandhro, Theeraphon Piacham, Watshara Shoombuatong, Pornlada Nuchnoi, Virapong Prachayasittikul, Jarl E. S. Wikberg and Chanin Nantasanamat
date: "October 13, 2015"
output: html_document
---
# PepBio: Predicting the bioactivity of host defense peptide

*Saw Simeon, Hao Li, Thet Su Win, Aijaz Ahmad Malik, Abdul Hafeez Kandhro, Theeraphon Piacham, Watshara Shoombuatong, Pornlada Nuchnoi, Virapong Prachayasittikul, Jarl E. S. Wikberg and Chanin Nantasanamat*

**Brief description**<br>
Below are the R code for constructing the predictive models consisting of: (i) binary models and (ii) multi-class model.

======

## 1. Binary models

### 1.1. Four Binary models (Bacteria/Negative, Cancer/Negative, Fungus/Negative and Virus/Negative)
Four separate binary models are built for each of the 4 bioactivity classes. The model of each bioactivity classifies a peptide as being positive (i.e. having the desired bioactivity) or negative (i.e. not having the desired bioactivity).
...
### 1.2. Binary model (HDP/Non-HDP)
Four bioactivity classes are merged as the **HDP** class while the negative set was used as the **Non-HDP** class.
...
## 2. Multi-class model
Four bioactivity classes and the negative class are combined together to build a singlee union model.
